...
ActiveRecord::Schema.define(version: 20161115111306) do
  ...
  create_table "stories_products", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "product_id"
    t.integer  "story_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["product_id"], name: "index_stories_products_on_product_id", using: :btree
    t.index ["story_id"], name: "index_stories_products_on_story_id", using: :btree
  end
